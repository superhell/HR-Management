...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldId.setFont(new java.awt.Font("Times", 3, 18)); // NOI18N

        jPasswordFieldPassword.setFont(new java.awt.Font("Times", 3, 18)); // NOI18N
        ...
        jButtonExit.setFont(new java.awt.Font("Times", 3, 18)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jPasswordFieldPassword, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        ...
        if (id.equals("admin")) {
            Integer loginResult = login(id, password);
            if (loginResult == 0) {

                JOptionPane.showMessageDialog(this, "Incorrect Password!", "Login Error", JOptionPane.ERROR_MESSAGE);
            } else if (loginResult == 1) {
                JOptionPane.showMessageDialog(this, "Login successfully!", "Login Successful", JOptionPane.INFORMATION_MESSAGE);
    ...
    private static Integer login(java.lang.String email, java.lang.String password) {
        sessionbean.LoginBeanService service = new sessionbean.LoginBeanService();
